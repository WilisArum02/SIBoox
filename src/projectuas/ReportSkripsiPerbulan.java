...
public class ReportSkripsiPerbulan extends javax.swing.JPanel {
    ...
    public ReportSkripsiPerbulan() {
        try {
            ...
            Logger.getLogger(ReportSkripsiPerbulan.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        txt_judul.setText("Cetak Peminjaman Skripsi Bulanan SIBoox");
        ...
        txt_menu1.setText("Home > Cetak > Bulanan Skripsi");
    ...
    private void jButtonCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCetakActionPerformed
        ...
        try {
            String reportPath = "src/projectuas/reportSkripsiPerbulan.jrxml";
            ...
            Root<Peminjamanskripsi_1> peminjamanskripsiRoot = criteriaQuery.from(Peminjamanskripsi_1.class);
            Join<Peminjamanskripsi_1, Skripsi_1> skripsiJoin = peminjamanskripsiRoot.join("idSkripsi", JoinType.INNER);
            ...
            if (!searchTerm.isEmpty()) {
                switch (jComboBoxPencarian.getSelectedIndex()) {
                    case 0:
                        predicates.add(criteriaBuilder.equal(peminjamanskripsiRoot.get("angkatan"), Integer.parseInt(searchTerm)));
                        break;
                    case 1:
                        predicates.add(criteriaBuilder.like(criteriaBuilder.lower(peminjamanskripsiRoot.get("nim")), "%" + searchTerm.toLowerCase() + "%"));
                        break;
                    default:
            ...
            if (tanggalAwal != null && tanggalAkhir != null) {
                predicates.add(criteriaBuilder.between(peminjamanskripsiRoot.get("tanggalPeminjaman"), tanggalAwal, tanggalAkhir));
            }
...
private void ambildata() {
    ...
    void getdatanim(String nim) {
        ...
        CriteriaQuery<Object[]> cq = cb.createQuery(Object[].class);
        Root<Peminjamanskripsi_1> peminjamanRoot = cq.from(Peminjamanskripsi_1.class);
        Join<Peminjamanskripsi_1, Skripsi_1> Skripsi_1 = peminjamanRoot.join("idSkripsi", JoinType.INNER); // Sesuaikan dengan nama atribut di entitas Peminjaman_1
