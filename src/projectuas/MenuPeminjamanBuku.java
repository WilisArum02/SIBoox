...
public class MenuPeminjamanBuku extends javax.swing.JPanel {
    ...
    private void tampil() {
        ...
        DefaultTableModel tbl = (DefaultTableModel) JTablePeminjaman.getModel();
        tbl.setRowCount(0);
    ...
    private void initComponents() {
        ...
        jComboJudulBuku = new javax.swing.JComboBox<>();
        ...
        txt_judul.setText("Data Peminjaman Buku SIBoox");
        ...
        txt_menu1.setText("Home > Peminjaman > Buku");
                        ...
                        .addGroup(jPanelDataBukuLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanelDataBukuLayout.createSequentialGroup()
                                ...
                                .addGroup(jPanelDataBukuLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    ...
                                    .addComponent(jComboJudulBuku, 0, 210, Short.MAX_VALUE)
            ...
            .addGroup(jPanelDataBukuLayout.createSequentialGroup()
                ...
                .addGroup(jPanelDataBukuLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanelDataBukuLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(jLabel5)
                        .addComponent(jComboJudulBuku, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void bt_tambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_tambahActionPerformed
        ...
        try {
            ...
            String judulBuku = jComboJudulBuku.getSelectedItem().toString(); // Ambil judul buku dari ComboBox
            ...
            Query bukuQuery = entityManager.createQuery("SELECT b FROM Buku_1 b WHERE b.judul = :judul");
            bukuQuery.setParameter("judul", judulBuku);
            Buku_1 buku = (Buku_1) bukuQuery.getSingleResult();

            // Membuat objek entitas Peminjaman_1
            Peminjaman_1 peminjaman = new Peminjaman_1();
            peminjaman.setIdPeminjaman(idPeminjaman);
            peminjaman.setNim(nim);
            ...
            jComboJudulBuku.setSelectedItem("Pilih Judul Buku");
...
// Mencari data peminjaman berdasarkan idPeminjaman
        Peminjaman_1 peminjaman = entityManager.find(Peminjaman_1.class, idPeminjaman);
...
// Refresh data setelah menghapus
    ...
    private void JTablePeminjamanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_JTablePeminjamanMouseClicked
        ...
        try {
            ...
            int row = JTablePeminjaman.getSelectedRow();
            String idPeminjaman = (JTablePeminjaman.getModel().getValueAt(row, 0).toString());

            // Gunakan EntityManager untuk mengambil data dari database
            Peminjaman_1 peminjaman = em.find(Peminjaman_1.class, idPeminjaman);

            if (peminjaman != null) {
                // Set nilai-nilai yang diambil dari database ke JTextField
                jTextIDPeminjaman.setText(peminjaman.getIdPeminjaman());
                jTextNIM.setText(peminjaman.getNim());
                jTextNama.setText(peminjaman.getNama());
                jTextProdi.setText(peminjaman.getProdi());
                jTextAngkatan.setText(peminjaman.getAngkatan());

                // Dapatkan judul buku dari relasi
                String judulBuku = peminjaman.getIsbn().getJudul();

                // Set nilai ComboBox judul buku
                jComboJudulBuku.setSelectedItem(judulBuku);

                // Set tanggal peminjaman
                Date tanggalPeminjamanDate = peminjaman.getTanggalPeminjaman();
                jDateChooserPinjam.setDate(tanggalPeminjamanDate);

                // Set tanggal pengembalian
                Date tanggalPengembalianDate = peminjaman.getTanggalPengembalian();
    ...
    private void getJudulBuku() {
        try {
            ...
            Query query = em.createQuery("SELECT b.judul FROM Buku_1 b");
            ...
            jComboJudulBuku.setModel(model);
            jComboJudulBuku.addActionListener(e -> {
                int selectedIndex = jComboJudulBuku.getSelectedIndex();
                ...
                if (selectedIndex > 0) {
                    try {
                        ...
                        Query selectQuery = emSelect.createQuery("SELECT b.isbn FROM Buku_1 b WHERE b.judul = :judul");
    ...
    private javax.swing.JComboBox<String> jComboJudulBuku;
