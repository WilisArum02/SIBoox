...
public class ReportPeminjamanBuku extends javax.swing.JPanel {
    ...
    public ReportPeminjamanBuku() {
        try {
            ...
            Logger.getLogger(ReportPeminjamanBuku.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        jButtonCetakKategoriJumlah = new javax.swing.JButton();
        ...
        txt_judul.setText("Cetak Peminjaman Buku SIBoox");
        ...
        txt_menu1.setText("Home > Cetak > Peminjaman Buku");
        ...
        jButtonCetakJumlah.setText("Jumlah Buku dipinjam");
        ...
        jButtonCetakKategoriJumlah.setBackground(new java.awt.Color(0, 0, 102));
        jButtonCetakKategoriJumlah.setForeground(new java.awt.Color(0, 153, 255));
        jButtonCetakKategoriJumlah.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Print.png"))); // NOI18N
        jButtonCetakKategoriJumlah.setText("Jumlah Kategori dipinjam");
        jButtonCetakKategoriJumlah.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonCetakKategoriJumlahActionPerformed(evt);
            }
        });
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jButtonCetakKategoriJumlah)
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(jButtonCetakKategoriJumlah, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButtonCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCetakActionPerformed
        ...
        try {
            ...
            String reportPath = "src/projectuas/reportPeminjamanBuku.jrxml";
            String searchTerm = jTextFieldPencarian1.getText().trim();
            
//            Date tanggalAwal = (Date) jDateChooserPinjam.getDate();
//            Date tanggalAkhir = (Date) jDateChooserTAKPB.getDate();
            ...
            CriteriaQuery<Object[]> cq = cb.createQuery(Object[].class);
            Root<Peminjaman_1> peminjamanRoot = cq.from(Peminjaman_1.class);
            Join<Peminjaman_1, Buku_1> bukuJoin = peminjamanRoot.join("isbn", JoinType.INNER);
    ...
    private void jButtonCetakJumlahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCetakJumlahActionPerformed
        try {
            String selection = (String) jComboBoxPencarian.getSelectedItem();
            String reportPath = "src/projectuas/reportJumlahPeminjamanBuku.jrxml";
            String searchTerm = jTextFieldPencarian1.getText().trim();
    ...
    private void jButtonCetakKategoriJumlahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCetakKategoriJumlahActionPerformed
        try {
            String selection = (String) jComboBoxPencarian.getSelectedItem();
            String reportPath = "src/projectuas/reportJumlahKategori.jrxml";
            String searchTerm = jTextFieldPencarian1.getText().trim();
            ...
            Root<Peminjaman_1> peminjamanRoot = cq.from(Peminjaman_1.class);
            Join<Peminjaman_1, Buku_1> bukuJoin = peminjamanRoot.join("isbn", JoinType.INNER);
            Join<Buku_1, Kategori_1> kategoriJoin = bukuJoin.join("idKategori", JoinType.INNER);
    ...
    }//GEN-LAST:event_jButtonCetakKategoriJumlahActionPerformed
    ...
    private javax.swing.JButton jButtonCetakKategoriJumlah;
